...
function CreateProduct() {
    ...
    const handleUpload = async e =>{
        ...
        try {
            ...
            if(!file) return alert("File ảnh không tồn tại")
    ...
    return (
        <div className="create_product">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="row">
                    <label htmlFor="exist">Số lượng</label>
                    <input type="number" name="exist" id="exist" required
                    value={product.exist} onChange={handleChangeInput} />
                </div>
                ...
                <div className="row">
                    <label htmlFor="content">Chủ đề</label>
                    <textarea type="text" name="content" id="content" required
                    value={product.content} rows="3" onChange={handleChangeInput} />
                </div>
